...
public class SettingsTour1Category4Pane {
    ...
    public SettingsTour1Category4Pane() {
        ...
        openMelody10Button.setOnMouseClicked(event -> {
            melody10 = fileChooser.showOpenDialog(getSettingsTour1Category4Scene().getWindow());
            if (melody10 != null) {
        ...
        openMelody20Button.setOnMouseClicked(event -> {
            melody20 = fileChooser.showOpenDialog(getSettingsTour1Category4Scene().getWindow());
            if (melody20 != null) {
        ...
        openMelody30Button.setOnMouseClicked(event -> {
            melody30 = fileChooser.showOpenDialog(getSettingsTour1Category4Scene().getWindow());
            if (melody30 != null) {
        ...
        openMelody40Button.setOnMouseClicked(event -> {
            melody40 = fileChooser.showOpenDialog(getSettingsTour1Category4Scene().getWindow());
            if (melody40 != null) {
        ...
        save10Button.setOnMouseClicked(event -> {
            if (melody10 != null) {
                ...
                try (FileInputStream fileInputStream = new FileInputStream(melody10);
                     FileOutputStream fileOutputStream = new FileOutputStream("musics/tour1/category4/points10/10.mp3")) {
                ...
                melody10 = null;
                media10 = new Media(new File("musics/tour1/category4/points10/10.mp3").toURI().toString());
            ...
            try (OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream("musics/tour1/category4/points10/10.xml"), "UTF-8")) {
        ...
        save20Button.setOnMouseClicked(event -> {
            if (melody20 != null) {
                ...
                try (FileInputStream fileInputStream = new FileInputStream(melody20);
                     FileOutputStream fileOutputStream = new FileOutputStream("musics/tour1/category4/points20/20.mp3")) {
                    byte[] bytes = new byte[1024];
                    while (fileInputStream.read(bytes) != -1) {
                        fileOutputStream.write(bytes);
                        fileOutputStream.flush();
                ...
                melody20 = null;
                media20 = new Media(new File("musics/tour1/category4/points20/20.mp3").toURI().toString());
            ...
            try (OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream("musics/tour1/category4/points20/20.xml"), "UTF-8")) {
                JAXBContext jaxbContext = JAXBContext.newInstance(Melody.class);
                Marshaller marshaller = jaxbContext.createMarshaller();
                marshaller.setProperty("jaxb.formatted.output", Boolean.TRUE);//отступы
        ...
        save30Button.setOnMouseClicked(event -> {
            if (melody30 != null) {
                ...
                try (FileInputStream fileInputStream = new FileInputStream(melody30);
                     FileOutputStream fileOutputStream = new FileOutputStream("musics/tour1/category4/points30/30.mp3")) {
                    byte[] bytes = new byte[1024];
                    while (fileInputStream.read(bytes) != -1) {
                        fileOutputStream.write(bytes);
                        fileOutputStream.flush();
                ...
                melody30 = null;
                media30 = new Media(new File("musics/tour1/category4/points30/30.mp3").toURI().toString());
            ...
            try (OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream("musics/tour1/category4/points30/30.xml"), "UTF-8")) {
                JAXBContext jaxbContext = JAXBContext.newInstance(Melody.class);
                Marshaller marshaller = jaxbContext.createMarshaller();
                marshaller.setProperty("jaxb.formatted.output", Boolean.TRUE);//отступы
        ...
        save40Button.setOnMouseClicked(event -> {
            if (melody40 != null) {
                ...
                try (FileInputStream fileInputStream = new FileInputStream(melody40);
                     FileOutputStream fileOutputStream = new FileOutputStream("musics/tour1/category4/points40/40.mp3")) {
                    byte[] bytes = new byte[1024];
                    while (fileInputStream.read(bytes) != -1) {
                        fileOutputStream.write(bytes);
                        fileOutputStream.flush();
                ...
                melody40 = null;
                media40 = new Media(new File("musics/tour1/category4/points40/40.mp3").toURI().toString());
            ...
            try (OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream("musics/tour1/category4/points40/40.xml"), "UTF-8")) {
                JAXBContext jaxbContext = JAXBContext.newInstance(Melody.class);
                Marshaller marshaller = jaxbContext.createMarshaller();
                marshaller.setProperty("jaxb.formatted.output", Boolean.TRUE);//отступы
        ...
        settingsTour1Category4Scene.getStylesheets().addAll(Main.getPathToResource("css/style.css"));
        settingsTour1Category4Pane.getChildren().addAll(settingsCategoriesBackground, categoryTextField, saveCategoryButton,
    ...
    public void start() {//при заходе на сцену
        try (InputStreamReader inputStreamReader = new InputStreamReader(new FileInputStream("settings/categories1.xml"), "UTF-8");
             InputStreamReader inputStreamReader10 = new InputStreamReader(new FileInputStream("musics/tour1/category4/points10/10.xml"), "UTF-8");
             InputStreamReader inputStreamReader20 = new InputStreamReader(new FileInputStream("musics/tour1/category4/points20/20.xml"), "UTF-8");
             InputStreamReader inputStreamReader30 = new InputStreamReader(new FileInputStream("musics/tour1/category4/points30/30.xml"), "UTF-8");
             InputStreamReader inputStreamReader40 = new InputStreamReader(new FileInputStream("musics/tour1/category4/points40/40.xml"), "UTF-8")) {
            ...
            File melody10 = new File("musics/tour1/category4/points10/10.mp3");
            if (melody10.exists()) {
            ...
            File melody20 = new File("musics/tour1/category4/points20/20.mp3");
            if (melody20.exists()) {
            ...
            File melody30 = new File("musics/tour1/category4/points30/30.mp3");
            if (melody30.exists()) {
            ...
            File melody40 = new File("musics/tour1/category4/points40/40.mp3");
            if (melody40.exists()) {
