...
public class SettingsRound3Controller extends AbstractSettingsRoundController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        initialize(category1Label, category2Label, category3Label, category4Label, backLabel, 3);
    }
