...
public class SettingsTour1Category1Pane {
    ...
    public void start() {//при заходе на сцену
        try (InputStreamReader inputStreamReader = new InputStreamReader(new FileInputStream("settings/categories1.xml"), "UTF-8");
            ...
            File melody10File = new File("musics/tour1/category1/points10/10.mp3");
            ...
            File melody20File = new File("musics/tour1/category1/points20/20.mp3");
            ...
            File melody30File = new File("musics/tour1/category1/points30/30.mp3");
            ...
            File melody40File = new File("musics/tour1/category1/points40/40.mp3");
