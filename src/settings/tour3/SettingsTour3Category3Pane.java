...
public class SettingsTour3Category3Pane {
        ...
        save10Button.setOnMouseClicked(event -> {
            if (melody10File != null) {
                ...
                try (FileInputStream fileInputStream = new FileInputStream(melody10File);
                     FileOutputStream fileOutputStream = new FileOutputStream("musics/tour3/category3/points10/10.mp3")) {
                ...
                melody10File = null;
                media10 = new Media(new File("musics/tour3/category3/points10/10.mp3").toURI().toString());
            ...
            try (OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream("musics/tour3/category3/points10/10.xml"), "UTF-8")) {
        ...
        save20Button.setOnMouseClicked(event -> {
            if (melody20File != null) {
                ...
                try (FileInputStream fileInputStream = new FileInputStream(melody20File);
                     FileOutputStream fileOutputStream = new FileOutputStream("musics/tour3/category3/points20/20.mp3")) {
                    byte[] bytes = new byte[1024];
                    while (fileInputStream.read(bytes) != -1) {
                        fileOutputStream.write(bytes);
                        fileOutputStream.flush();
                ...
                melody20File = null;
                media20 = new Media(new File("musics/tour3/category3/points20/20.mp3").toURI().toString());
            ...
            try (OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream("musics/tour3/category3/points20/20.xml"), "UTF-8")) {
                JAXBContext jaxbContext = JAXBContext.newInstance(Melody.class);
                Marshaller marshaller = jaxbContext.createMarshaller();
                marshaller.setProperty("jaxb.formatted.output", Boolean.TRUE);//отступы
        ...
        save30Button.setOnMouseClicked(event -> {
            if (melody30File != null) {
                ...
                try (FileInputStream fileInputStream = new FileInputStream(melody30File);
                     FileOutputStream fileOutputStream = new FileOutputStream("musics/tour3/category3/points30/30.mp3")) {
                    byte[] bytes = new byte[1024];
                    while (fileInputStream.read(bytes) != -1) {
                        fileOutputStream.write(bytes);
                        fileOutputStream.flush();
                ...
                melody30File = null;
                media30 = new Media(new File("musics/tour3/category3/points30/30.mp3").toURI().toString());
            ...
            try (OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream("musics/tour3/category3/points30/30.xml"), "UTF-8")) {
                JAXBContext jaxbContext = JAXBContext.newInstance(Melody.class);
                Marshaller marshaller = jaxbContext.createMarshaller();
                marshaller.setProperty("jaxb.formatted.output", Boolean.TRUE);//отступы
        ...
        save40Button.setOnMouseClicked(event -> {
            if (melody40File != null) {
                ...
                try (FileInputStream fileInputStream = new FileInputStream(melody40File);
                     FileOutputStream fileOutputStream = new FileOutputStream("musics/tour3/category3/points40/40.mp3")) {
                    byte[] bytes = new byte[1024];
                    while (fileInputStream.read(bytes) != -1) {
                        fileOutputStream.write(bytes);
                        fileOutputStream.flush();
                ...
                melody40File = null;
                media40 = new Media(new File("musics/tour3/category3/points40/40.mp3").toURI().toString());
            ...
            try (OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream("musics/tour3/category3/points40/40.xml"), "UTF-8")) {
                JAXBContext jaxbContext = JAXBContext.newInstance(Melody.class);
                Marshaller marshaller = jaxbContext.createMarshaller();
                marshaller.setProperty("jaxb.formatted.output", Boolean.TRUE);//отступы
    ...
    public void start() {//при заходе на сцену
        try (InputStreamReader inputStreamReader = new InputStreamReader(new FileInputStream("settings/categories3.xml"), "UTF-8");
             InputStreamReader inputStreamReader10 = new InputStreamReader(new FileInputStream("musics/tour3/category3/points10/10.xml"), "UTF-8");
             InputStreamReader inputStreamReader20 = new InputStreamReader(new FileInputStream("musics/tour3/category3/points20/20.xml"), "UTF-8");
             InputStreamReader inputStreamReader30 = new InputStreamReader(new FileInputStream("musics/tour3/category3/points30/30.xml"), "UTF-8");
             InputStreamReader inputStreamReader40 = new InputStreamReader(new FileInputStream("musics/tour3/category3/points40/40.xml"), "UTF-8")) {
            ...
            File melody10File = new File("musics/tour3/category3/points10/10.mp3");
            ...
            File melody20File = new File("musics/tour3/category3/points20/20.mp3");
            ...
            File melody30File = new File("musics/tour3/category3/points30/30.mp3");
            ...
            File melody40File = new File("musics/tour3/category3/points40/40.mp3");
